...
{
    partial class ParentDashboardForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblBannerSubtext = new Label();
            btnNotifications = new Guna.UI2.WinForms.Guna2Button();
            picUserAvatar = new Guna.UI2.WinForms.Guna2Panel();
            lblUserAvatarInitial = new Label();
            lblQuickActionsTitle = new Label();
            btnBookBabysitter = new Guna.UI2.WinForms.Guna2Button();
            btnFindBabysitters = new Guna.UI2.WinForms.Guna2Button();
            ...
            btnNavAdmin = new Guna.UI2.WinForms.Guna2Button();
            ...
            pnlContent.Controls.Add(lblQuickActionsTitle);
            pnlContent.Controls.Add(btnBookBabysitter);
            pnlContent.Controls.Add(btnFindBabysitters);
            ...
            pnlWelcomeBanner.Controls.Add(lblBannerSubtext);
            pnlWelcomeBanner.Controls.Add(btnNotifications);
            pnlWelcomeBanner.Controls.Add(picUserAvatar);
            pnlWelcomeBanner.CustomizableEdges = customizableEdges5;
            ...
            lblGreeting.Location = new Point(35, 22);
            ...
            lblUserName.Text = "<div style=\"color:white;font-weight:bold;font-size:14pt;\">Sarah Mitchell &#128075;</div>";
            // 
            // lblBannerSubtext
            // 
            lblBannerSubtext.BackColor = Color.Transparent;
            lblBannerSubtext.ForeColor = Color.White;
            lblBannerSubtext.Location = new Point(35, 90);
            lblBannerSubtext.Margin = new Padding(4, 0, 4, 0);
            lblBannerSubtext.Name = "lblBannerSubtext";
            lblBannerSubtext.Size = new Size(450, 25);
            lblBannerSubtext.TabIndex = 2;
            lblBannerSubtext.Text = "You have 2 upcoming bookings this week.";
            // 
            // btnNotifications
            // 
            btnNotifications.BorderRadius = 22;
            btnNotifications.CustomizableEdges = customizableEdges1;
            ...
            // picUserAvatar
            // 
            picUserAvatar.BorderRadius = 22;
            picUserAvatar.Controls.Add(lblUserAvatarInitial);
            ...
            // 
            // lblUserAvatarInitial
            // 
            lblUserAvatarInitial.BackColor = Color.Transparent;
            lblUserAvatarInitial.Dock = DockStyle.Fill;
            lblUserAvatarInitial.Font = new Font("Segoe UI", 13F, FontStyle.Bold);
            lblUserAvatarInitial.ForeColor = Color.FromArgb(232, 113, 74);
            lblUserAvatarInitial.Location = new Point(0, 0);
            lblUserAvatarInitial.Margin = new Padding(4, 0, 4, 0);
            lblUserAvatarInitial.Name = "lblUserAvatarInitial";
            lblUserAvatarInitial.Size = new Size(55, 55);
            lblUserAvatarInitial.TabIndex = 0;
            lblUserAvatarInitial.Text = "S";
            lblUserAvatarInitial.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // lblQuickActionsTitle
            // 
            lblQuickActionsTitle.BackColor = Color.Transparent;
            lblQuickActionsTitle.Font = new Font("Segoe UI", 11F, FontStyle.Bold);
            lblQuickActionsTitle.ForeColor = Color.FromArgb(154, 136, 128);
            lblQuickActionsTitle.Location = new Point(30, 188);
            lblQuickActionsTitle.Margin = new Padding(4, 0, 4, 0);
            lblQuickActionsTitle.Name = "lblQuickActionsTitle";
            lblQuickActionsTitle.Size = new Size(250, 28);
            ...
            btnBookBabysitter.TabIndex = 2;
            btnBookBabysitter.Text = "➕  Book a Babysitter";
            btnBookBabysitter.Click += btnBookBabysitter_Click;
            // 
            // btnFindBabysitters
            // 
            ...
            btnFindBabysitters.TabIndex = 3;
            btnFindBabysitters.Text = "🔍  Find Babysitters";
            btnFindBabysitters.Click += btnFindBabysitters_Click;
            // 
            // btnFavorites
            // 
            ...
            btnFavorites.TabIndex = 4;
            btnFavorites.Text = "❤  Favorites";
            btnFavorites.Click += btnFavorites_Click;
            // 
            // lblUpcomingTitle
            // 
            lblUpcomingTitle.BackColor = Color.Transparent;
            lblUpcomingTitle.Font = new Font("Segoe UI", 11F, FontStyle.Bold);
            lblUpcomingTitle.ForeColor = Color.FromArgb(154, 136, 128);
            lblUpcomingTitle.Location = new Point(30, 350);
            lblUpcomingTitle.Margin = new Padding(4, 0, 4, 0);
            lblUpcomingTitle.Name = "lblUpcomingTitle";
            lblUpcomingTitle.Size = new Size(275, 28);
            lblUpcomingTitle.TabIndex = 5;
            lblUpcomingTitle.Text = "Upcoming Bookings";
            // 
            // btnViewAllBookings
            // 
            ...
            btnNavAdmin.Click += btnNavAdmin_Click;
            // 
            // ParentDashboardForm
            // 
            ...
            Text = "Meraki - Parent Dashboard";
            Load += ParentDashboardForm_Load;
        ...
        private Guna.UI2.WinForms.Guna2Button btnNavAdmin;
        ...
        private System.Windows.Forms.Label lblBannerSubtext;
        private Guna.UI2.WinForms.Guna2Button btnNotifications;
        private Guna.UI2.WinForms.Guna2Panel picUserAvatar;
        private System.Windows.Forms.Label lblUserAvatarInitial;
        private System.Windows.Forms.Label lblQuickActionsTitle;
        private Guna.UI2.WinForms.Guna2Button btnBookBabysitter;
